...
export class RegisterComponent extends PersistAbstract<User> implements OnInit {
  ...
  constructor(protected userService: UserService,
    ...
    super(userService, notificationService, route);
  }
  ...
  getCityByUf(id) {
      this.userService.getCityByUf(id).subscribe(resp => {
        this.cityList.allCities = resp;
    });
  }
  findCep(cep) {
    this.userService.findCep(cep).subscribe(resp => {
  ...
  ngOnInit() {
    ...
    this.onReceiveData();
    this.userService.getAllStates().subscribe(resp => {
  ...
  goBack(): void {
    ...
    transformBeforeSave(data: User): User {
