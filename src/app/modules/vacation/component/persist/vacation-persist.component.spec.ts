...
import {VacationPersistComponent} from './vacation-persist.component';
...
describe('Component: Vacation', () => {
  ...
  let component: VacationPersistComponent;
  let fixture: ComponentFixture<VacationPersistComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [VacationPersistComponent],
      providers: [
        NotificationService,
        VacationService
      ]
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(VacationPersistComponent);
